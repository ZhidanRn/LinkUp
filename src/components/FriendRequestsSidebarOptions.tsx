...
const FriendRequestsSidebarOptions: FC<FriendRequestsSidebarOptionsProps> = ({
  ...
  return <Link href={'/dashboard/requests'} className="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex rounded-md items-center gap-x-3 p-2 text-sm leading-6 font-semibold" >
